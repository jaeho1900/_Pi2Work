...
# KNN모형평가: 미생존자(0) 예측정확도가 0.84 , 생존자(1) 예측정확도가 0.76 으로 예측 능력의 차이가 있음
...
# SVM모형평가: 미생존자(0) 예측정확도가 0.86 , 생존자(1) 예측정확도가 0.73 으로 KMM모형과 유사함
...
print(tree_report)
# 양성예측정확도는 0.98 , 악성예측정확도는 0.96 으로 평균 0.97 의 정확도를 가짐
